        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="border-bottom pb-4 d-lg-flex align-items-center justify-content-between">
                <div class="mb-2 mb-lg-0">
                    <h1 class="mb-0 h2 fw-bold text-dark">Account Security </h1>
                    <!-- Breadcrumb -->
    ...
    <div class="py-6">
        ...
        <div class="row">
                        ...
                        <form method="post" action="{{ route('admin.updatePassword') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-12 password-toggle">
                                    <label class="form-label text-dark">Current Password <span
                                ...
                                <div class="mb-3 col-12 password-toggle">
                                    <label class="form-label text-dark">Confirm New Password <span
                                            class="text-danger">*</span></label>
            ...
            <div class="offset-xl-2 col-xl-8 col-md-12 col-12">
                ...
                <div class="card mb-6">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 text-dark">Two Factor Authentication</h4>
                    </div>
                    <!-- card body -->
                    <div class="card-body">
                        <div class="mb-5">
                            <h4 class="mb-0 text-dark">Receive 2FA Code Via Email</h4>
                            <!-- List group -->
                            <ul class="list-group list-group-flush">
                                <!-- List group item -->
                                <li class="list-group-item d-flex align-items-center justify-content-between px-0 py-2">
                                    <div class="text-dark">Receive an authentication code via your registered email address for every new
                                        sign-in attempt.</div>
                                    <div>
                        ...
                        <div class="mb-5">
                            <h4 class="mb-0 text-dark">Google Authenticator</h4>
                            <!-- List group -->
                            <ul class="list-group list-group-flush">
                                <!-- List group item -->
                                <li class="list-group-item d-flex align-items-center justify-content-between px-0 py-2">
                                    <div class="row">
                                        <div class="text-dark">Get your authentication code via the Google Authenticator app for every
    ...
    <div class="modal-dialog modal-md " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark" id="exampleModalLongTitle">Enable Google Authenticator</h5>
