        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="border-bottom pb-3 mb-3 d-lg-flex align-items-center justify-content-between">
                <div class="mb-2 mb-lg-0">
                    <h1 class="mb-0 h3 fw-bold text-dark">Roles and Permissions</h1>
                    <!-- Breadcrumb -->
                    ...
                    <div class="tab-content" id="tabContent">
                        ...
                        <div class="tab-pane fade show active" id="all-orders" role="tabpanel"
                            ...
                            <div class="table-responsive" style="min-height:200px">
                                <!-- Table -->
                                <table id="" class="table mb-0 text-nowrap table-hover table-centered table-with-checkbox"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($userRoles as $role)
                                            <tr>
                                                ...
                                                <td class="text-dark">{{ $role->role }}</td>
                                                <td class="text-dark"> {{ $role->totalPermissions() }} Permissions Found
                                                </td>
                                                <td class="text-dark">
                                                    {{ date_format($role->created_at, 'jS F, Y g:ia') }}</td>
