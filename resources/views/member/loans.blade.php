...
@section('content')
@section('title', env('APP_NAME') . ' | Member Loan Records')
                                                        ...
                                                        <span class="dropdown-menu"><span
                                                            ...
                                                            <a style="cursor:pointer" class="dropdown-item"
                                                                ...
                                                                data-balance="{{ number_format($loan->balance(), 2) }}"><i
                                                                    class="fe fe-edit dropdown-item-icon"></i>View
                                                                Details</a>
...
<script type="text/javascript">
    document.getElementById("loans").classList.add('active');
</script>
