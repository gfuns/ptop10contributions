...
Route::group([
    ...
    Route::post('/loans/search', [AdminController::class, 'loanSearch'])->name("admin.loanSearch");

    Route::get('/loans/search/result/{id}', [AdminController::class, 'loanSearchResult'])->name("admin.loanSearchResult");
